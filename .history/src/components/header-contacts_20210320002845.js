...
const HeaderContacts = () => {
  ...
  return (
    ...
    <div className="header-contacts" data-aos="fade-left">
        <a href="tel:79514860470" className="header-contacts__item  header-contacts__phone">
        ...
        <a href="mailto:hello@borodin.rocks" className="header-contacts__item header-contacts__email">
            <div className="header-contacts__icon">
        ...
        <div className="header-contacts__item header-contacts__request">
            Оставить заявку
        </div>
        <div className="header-contacts__menu" onClick={toggleMenu}>
