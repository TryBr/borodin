                        ...
                        <div className="col-lg-12">
                            <div className="clients-slider-desktop">
                                ...
                                >
                                    {
                                        logos.map((logo, i) => (
                                            <SwiperSlide key={`cl-${node.id}`} className="clients-item">
                                                <img src={logo.file.url} alt="" className="clients-item__logo"/>
                                            </SwiperSlide>
                                        ))
                                    }
                                </Swiper>
                                ...
                                >
                                    {
                                        logos.map((logo, i) => (
                                            <SwiperSlide className="clients-item">
                                                <img key={i} src={logo.file.url} alt="" className="clients-item__logo"/>
                                            </SwiperSlide>
                                        ))
                                    }
                                </Swiper>
