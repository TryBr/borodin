    ...
    <div className="container">
      <div className="row">
        <div className="col-lg-12">
          <Breadcrumb location={location} crumbLabel="Политика конфиденциальности" />
        </div>
      </div>
    </div>
    <div className="page page-policy">
      <h1 className="page__title page-404__title">
      ...
      <div className="page-description">
            ...
            <div className="row">
              ...
              <p>
                ...
                по обеспечению безопасности персональных данных Бородин
                Дмитрий Станиславович (далее – Оператор).
              </p>
              <ul>
                <li>
                ...
                <li>
                  ...
                  посетителях веб-сайта https://borodin.rocks.
                </li>
              </ul>
              <h2 className="title-h2">
              ...
              <ul>
                ...
                <li>
                  ...
                  сетевому адресу https://borodin.rocks;
                </li>
                <li>
                ...
                <li>
                  ...
                  определяемому Пользователю веб-сайта https://
                  borodin.rocks;
                </li>
                <li>
                  Пользователь – любой посетитель веб-сайта https://
                  borodin.rocks;
                </li>
                <li>
                ...
                <li>
                  ...
                  предоставление доступа к персональным данным какимлибо иным способом;
                </li>
                <li>
                ...
                <li>
                  ...
                  результате которых уничтожаются материальные
              ...
              <ul>
                ...
                <li>Также на сайте происходит сбор и обработка
                обезличенных данных о посетителях (в т.ч. файлов
                «cookie») с помощью сервисов интернет-статистики
                (Яндекс Метрика и Гугл Аналитика и других).</li>
                <li>Вышеперечисленные данные далее по тексту Политики
                объединены общим понятием Персональные данные.</li>
              </ul>
              <h2 className="title-h2">
              ...
              <ul>
                ...
                <li>
                  ...
                  предложениях и различных событиях. Пользователь
                  всегда может отказаться от получения информационных
                  сообщений, направив Оператору письмо на адрес
                  электронной почты hello@borodin.rocks с пометкой
                  «Отказ от уведомлениях о новых продуктах и услугах и
                  специальных предложениях».
                </li>
                <li>
                  Обезличенные данные Пользователей, собираемые с
                  помощью сервисов интернет-статистики, служат для
                  сбора информации о действиях Пользователей на сайте,
              ...
              <ul>
                <li>
                  ...
                  специальные формы, расположенные на сайте https://
                  borodin.rocks. Заполняя соответствующие формы и/или
                  отправляя свои персональные данные Оператору,
                  Пользователь выражает свое согласие с данной
                  Политикой.
                </li>
                <li>
    ...
    персональных данных
              ...
              <ul>
                ...
                <li>
                  ...
                  уведомление на адрес электронной почты Оператора hello@borodin.rocks с пометкой «Актуализация
                  персональных данных».
                </li>
                <li>
                  ...
                  Оператора hello@borodin.rocks с пометкой «Отзыв
              ...
              <ul>
                <li>
                  ...
                  данных, обеспечивается надежная защита прав
              ...
              <ul>
                <li>
                  ...
                  помощью электронной почты hello@borodin.rocks.
                </li>
                <li>
                  В данном документе будут отражены любые изменения
                политики обработки персональных данных Оператором.
                Политика действует бессрочно до замены ее новой
                версией.
                </li>
                <li>
                  Актуальная версия Политики в свободном доступе
                  расположена в сети Интернет по адресу https://
                  borodin.rocks/policy/.
                </li>
              </ul>
              </div>
            </div>
